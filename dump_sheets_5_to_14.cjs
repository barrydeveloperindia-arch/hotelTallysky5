...
const sheetsToRead = [
  '05.06.26', '06.06.26', '07.06.26', '08.06.26', '09.06.26',
  '10.06.26', '11.06.26', '12.06.26', '13.06.26', '14.06.26'
];
...
try {
  ...
  sheetsToRead.forEach(sheetName => {
    ...
    fsExtra.writeFileSync(outputFilePath, JSON.stringify(rows, null, 2));
