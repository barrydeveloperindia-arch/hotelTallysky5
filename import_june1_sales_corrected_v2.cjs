...
const knownBills = {
  ...
  "16024": [
    { name: "Tea", qty: 7, rate: 39.52, amt: 276.64 },
    { name: "Poha", qty: 2, rate: 66.67, amt: 133.34 },
    { name: "Bread Toast", qty: 2, rate: 47.39, amt: 94.78 }
  ],
  "16022": [
...
const staysToImport = [
  { invoiceNo: "11908", guest: "ROBI STEPHAN SS", date: "20260601", amount: 1100.00, rooms: ["Room 19"], partyLedger: "ROBI STEPHAN SS", revenueLedger: "Sale 5% Haryana B2C" },
  ...
  { invoiceNo: "180962826-000231", guest: "SHARAJ SINGH PADDA", date: "20260601", amount: 1638.00, rooms: ["Room 04"], partyLedger: "TREEBO HOTELS", revenueLedger: "SALES B2B 5% HARYANA" }, // B2B Stay
  { invoiceNo: "11911", guest: "MAYANK SHRIVASTVA", date: "20260601", amount: 3600.00, rooms: ["Room 07", "Room 08"], partyLedger: "MAYANK SHRIVASTVA", revenueLedger: "Sale 5% Haryana B2C" },
  { invoiceNo: "11909", guest: "HARDEEP SINGH", date: "20260601", amount: 1700.00, rooms: ["Room 17"], partyLedger: "HARDEEP SINGH", revenueLedger: "Sale 5% Haryana B2C" },
  { invoiceNo: "11912", guest: "TARUN GOYAL", date: "20260601", amount: 1100.00, rooms: ["Room 20"], partyLedger: "TARUN GOYAL", revenueLedger: "Sale 5% Haryana B2C" },
  { invoiceNo: "11906", guest: "PARSHANT", date: "20260601", amount: 1500.00, rooms: ["Room 11"], partyLedger: "PARSHANT", revenueLedger: "Sale 5% Haryana B2C" },
  { invoiceNo: "11910", guest: "RAHUL PUROHIT", date: "20260601", amount: 2000.00, rooms: ["Room 10"], partyLedger: "RAHUL PUROHIT", revenueLedger: "Sale 5% Haryana B2C" },
  { invoiceNo: "11913", guest: "RAJEEV PARMAR", date: "20260601", amount: 1200.00, rooms: ["Room 16"], partyLedger: "RAJEEV PARMAR", revenueLedger: "Sale 5% Haryana B2C" }
];

const foodBillsToImport = [
  { billNo: "16028", guest: "SHARAJ SINGH PADDA", date: "20260601", total: 60.00, rooms: ["Room 04"], partyLedger: "SHARAJ SINGH PADDA" }, // B2C Food for Treebo guest
  { billNo: "16024", guest: "MAYANK SHRIVASTVA", date: "20260601", total: 530.00, rooms: ["Room 07", "Room 08"], partyLedger: "MAYANK SHRIVASTVA" },
  ...
  { billNo: "16025", guest: "PARSHANT", date: "20260601", total: 591.00, rooms: ["Room 11"], partyLedger: "PARSHANT" },
...
const paymentJVs = [
  ...
  { vchNo: "PAY-16028", date: "20260601", guest: "SHARAJ SINGH PADDA", debits: [{ ledger: "CONSUMER", amt: 60.00 }], credit: 60.00 }, // Food only payment
  { jvType: "split", vchNo: "PAY-11911", date: "20260601", guest: "MAYANK SHRIVASTVA", debits: [{ ledger: "Cash", amt: 2600.00 }, { ledger: "CONSUMER", amt: 1530.00 }], credit: 4130.00 }, // Stays + Food payment
  ...
  { vchNo: "PAY-11906", date: "20260601", guest: "PARSHANT", debits: [{ ledger: "CONSUMER", amt: 2091.00 }], credit: 2091.00 }, // Stays + Food payment
...
<ENVELOPE>
  ...
  console.log("\nSales Vouchers and Payment JVs Import Completed!");
}
