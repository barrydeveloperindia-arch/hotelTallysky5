...
const foodBillsToImport = [
  ...
  // Varun food bill POS-16022 omitted since no physical bill exists
  // Hardeep Singh food bill POS-16033 omitted since no physical bill exists
...
const paymentJVs = [
  ...
  { vchNo: "PAY-11907", date: "20260601", guest: "HARDEEP SINGH", debits: [{ ledger: "CONSUMER", amt: 1700.00 }], credit: 1700.00 }, // Hardeep payment set to 1700 as corrected manually by user
