...
This report contains all valid, deduplicated Sales Vouchers extracted from 215 PDFs across 10 days.
...
* **Credit** | `Sales B2B 5% HARYANA` : **1633.81**
...
* **Credit** | `Sale 5% Haryana B2C` : **57.16**
  * *Cost Centre*:
    * `Staff Tea` -> `Rooms` -> `Room A&A` : 57.16 Cr
...
* **Credit** | `Sales B2B 5% HARYANA` : **1619.05**
...
* **Credit** | `Sales B2B 5% HARYANA` : **1714.29**
...
* **Credit** | `Sales B2B 5% HARYANA` : **1904.76**
...
* **Credit** | `Sales B2B 5% HARYANA` : **3142.86**
...
* **Credit** | `Sales B2B 5% HARYANA` : **1142.86**
...
* **Credit** | `Sales B2B 5% HARYANA` : **2857.14**
...
* **Credit** | `Sales B2B 5% HARYANA` : **952.38**
...
* **Credit** | `Sales B2B 5% HARYANA` : **1679.05**
...
* **Credit** | `Sales B2B 5% HARYANA` : **2095.24**
...
* **Credit** | `Sales B2B 5% HARYANA` : **1688.57**
...
* **Credit** | `Sales B2B 5% HARYANA` : **4880.96**
...
* **Credit** | `Sales B2B 5% HARYANA` : **5211.24**
...
* **Credit** | `Sales B2B 5% HARYANA` : **1428.57**
...
* **Credit** | `Sales B2B 5% HARYANA` : **1047.62**
...
* **Credit** | `Sale 5% Haryana B2C` : **76.20**
  * *Cost Centre*:
    * `Lemon Water` -> `Rooms` -> `Room PACKING 276` : 76.20 Cr
* **Credit** | `Output Cgst 2.5%` : **1.91**
* **Credit** | `Output Sgst 2.5%` : **1.91**
...
* **Credit** | `Sale 5% Haryana B2C` : **77.93**
  * *Cost Centre*:
    * `French Fries` -> `Rooms` -> `Room Table No ENGLABS` : 98.73 Cr
    * `Mineral Water` -> `Rooms` -> `Room Table No ENGLABS` : 57.14 Cr
...
* **Credit** | `Sale 5% Haryana B2C` : **114.30**
  * *Cost Centre*:
    * `Lemon Water` -> `Rooms` -> `Room Table No MD SIR` : 228.60 Cr
...
* **Credit** | `Sale 5% Haryana B2C` : **119.04**
  * *Cost Centre*:
    * `Poha` -> `Rooms` -> `Room Table No SHREEYA` : 66.67 Cr
    * `Veg. Sandwich` -> `Rooms` -> `Room Table No SHREEYA` : 171.42 Cr
...
* **Credit** | `Sales B2B 5% HARYANA` : **4857.15**
...
* **Credit** | `Sales B2B 5% HARYANA` : **1333.33**
...
* **Credit** | `Sale 5% Haryana B2C` : **192.22**
  * *Cost Centre*:
    * `French Fries` -> `Rooms` -> `Room MD SIR` : 98.73 Cr
    * `Lemon Water` -> `Rooms` -> `Room MD SIR` : 114.30 Cr
    * `Veg. Sandwich` -> `Rooms` -> `Room MD SIR` : 171.42 Cr
...
* **Credit** | `Sales B2B 5% HARYANA` : **3428.58**
...
* **Credit** | `Sales B2B 5% HARYANA` : **18801.50**
...
* **Credit** | `Sales B2B 5% HARYANA` : **1787.57**
...
* **Credit** | `Sales B2B 5% HARYANA` : **1523.81**
...
* **Credit** | `Sales B2B 5% HARYANA` : **2898.48**
...
* **Credit** | `Sale 5% Haryana B2C` : **227.29**
  * *Cost Centre*:
    * `Veg. Sandwich` -> `Rooms` -> `Room SHREEYA` : 257.13 Cr
    * `French Fries` -> `Rooms` -> `Room SHREEYA` : 197.46 Cr
...
* **Credit** | `Sale 5% Haryana B2C` : **66.68**
  * *Cost Centre*:
    * `Staff Coffee` -> `Rooms` -> `Room A&A` : 38.10 Cr
    * `Staff Tea` -> `Rooms` -> `Room A&A` : 28.58 Cr
* **Credit** | `Output Cgst 2.5%` : **1.67**
* **Credit** | `Output Sgst 2.5%` : **1.67**
...
* **Credit** | `Sale 5% Haryana B2C` : **38.10**
  * *Cost Centre*:
    * `Staff Coffee` -> `Rooms` -> `Room S& A` : 38.10 Cr
* **Credit** | `Output Cgst 2.5%` : **0.96**
* **Credit** | `Output Sgst 2.5%` : **0.96**
...
* **Credit** | `Sales B2B 5% HARYANA` : **2243.05**
...
* **Credit** | `Sales B2B 5% HARYANA` : **2620.95**
...
* **Debit** | `AMIT` : **3030.00**
* **Credit** | `Sales B2B 5% HARYANA` : **2288.81**
...
* **Credit** | `Sales B2B 5% HARYANA` : **1964.76**
...
* **Credit** | `Sales B2B 5% HARYANA` : **1343.86**
...
* **Credit** | `Sale 5% Haryana B2C` : **23.81**
  * *Cost Centre*:
    * `Limca 250 Ml` -> `Rooms` -> `Room PACKING 279` : 23.81 Cr
* **Credit** | `Output Cgst 2.5%` : **0.60**
* **Credit** | `Output Sgst 2.5%` : **0.60**
